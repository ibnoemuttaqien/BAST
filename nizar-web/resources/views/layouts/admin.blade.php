    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
           ...
           with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.kategori_pembuatan.index') }}" class="nav-link">
                                <i class="nav-icon fas fa-tags"></i>
                                <p>
                                    Kelola Kategori Pembuatan
                                </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.kategori_grade.index') }}" class="nav-link">
                                <i class="nav-icon fas fa-star"></i>
                                <p>
                                    Kelola Kategori Grade
                                </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.laporan_hasil') }}" class="nav-link">
