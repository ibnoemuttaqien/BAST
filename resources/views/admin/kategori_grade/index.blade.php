...
@section('content')
    <div class="container mt-4">
        ...
        @endif
        <h3 class="mb-4">Daftar Kategori Grade</h3>
        <hr>
        ...
        <div class="table-responsive">
            <table id="table-ok" class="table table-striped table-bordered">
                ...
                <tbody>
                    @foreach ($kategoriGrade as $category)
                        <tr>
    ...
    <div id="createCategoryModal" class="custom-modal">
        <div class="custom-modal-content">
            ...
            <form action="{{ route('admin.kategori_grade.store') }}" method="POST">
                @csrf
    ...
    <script>
        ...
        function openEditModal(id, nama) {
            ...
            document.getElementById('editCategoryForm').action = `/admin/kategori_grade/${id}`;
        ...
        function openDeleteModal(id) {
            ...
            document.getElementById('deleteForm').action = `/admin/kategori_grade/${id}`;
